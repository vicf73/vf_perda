...
def main():
    ...
    st.set_page_config(
        page_title="Sistema de Gestão de Dados - V.Ferreira (Local)",
        page_icon="📊",
        layout="wide",
        initial_sidebar_state="expanded"
    )
    ...
    try:
        ...
        try:
            with db_manager.engine.connect() as conn:
                ...
                st.sidebar.success(f"✅ Conectado ao PostgreSQL Local")
        ...
        st.error(f"O aplicativo não pôde se conectar ao banco de dados. Verifique se o PostgreSQL está rodando localmente.")
