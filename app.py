...
def manager_page(db_manager):
    ...
    st.title(f"Bem-vindo(a), {user['nome']}!")<｜end▁of▁thinking｜>Analisando o código fornecido, identifiquei várias oportunidades de melhorias e correções de segurança. Vou implementar as principais:
...
- Pool de conexões com reciclagem
- Queries otimizadas

### 3. **Experiência do Usuário**
- Feedback visual melhorado
- Spinners durante operações lentas
...
Aqui está o código completo com todas as melhorias:
